  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-10 px-4 sm:px-6">
      ...
      <div className="max-w-sm w-full mx-auto bg-white rounded-lg border border-slate-200 p-6 sm:p-7">
        ...
        {/* Google Sign In Button - Belum Tersedia */}
        <button
          type="button"
          onClick={handleGoogleSignIn}
          className="w-full min-h-[40px] py-2 px-3 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-medium rounded-md transition-colors flex items-center justify-between mb-4 cursor-pointer"
        >
