...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200/90 pb-[env(safe-area-inset-bottom)]"
    >
      <div className="grid grid-cols-5 h-15 max-w-lg mx-auto items-center px-1">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center w-full h-full min-h-[44px] text-blue-600 group active:scale-95 transition-transform"
        >
